...
Jeka.Shop.bindPlusMinusButtons = function () {
    $(".buy-product .plus, .buy-product .minus").click(function () {
        var inc = $(this).hasClass('plus') ? 1 : -1;
        var $quantity = $(".buy-product input.quantity");
...
Jeka.Shop.Forms.toCartAjaxEvent=function(){
    ...
    window.setTimeout(function(){submitButton.removeAttr('disabled')},2000);
